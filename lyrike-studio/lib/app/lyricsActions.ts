...
export function createLyricsActions(params: {
  ...
  return {
    ...
    resizeLineLive(lineId: string, start: number, end: number): void {
      params.lyricsStore.setLineRangeLive(lineId, start, end);
    },
    ...
    resizeLineCommit(
      ...
      params.lyricsStore.setLineRange(lineId, start, end, baseState);
    },
